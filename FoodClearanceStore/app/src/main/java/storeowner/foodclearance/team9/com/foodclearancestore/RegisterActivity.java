...
public class RegisterActivity extends AppCompatActivity {
    static final String APP_SERVER_URL = "http://project9.comxa.com/php/db_insert_storeOwners.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText storeUsername = (EditText)findViewById(R.id.sUsername);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sUsername = storeUsername.getText().toString();
